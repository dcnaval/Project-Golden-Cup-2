...
?>
     ...
     if ($stats=="Confirmed") {
      ...
      <!---------------------their is a receipt--->   
   <?php }else{ ?>
          <a href="official_receipt1.php?id=<?php echo $row['OrderID']; ?>"><font color="red"><U>Receipt </U></font></a>
           ...
           <a rel="tooltip"  title="Delete" id="<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete?')" href="user_deleteor.php?id=<?php echo $row['OrderID'];?>" data-toggle="modal"    class="btn btn-danger"><font size="1">X</font></a>
