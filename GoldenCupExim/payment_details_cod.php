...
<html lang="en">
  <head>
    ...
    <title>GoldenCup Exim Marketing Corp</title>
...
?>
        Your order has been sent successfully.</h3>
        Click <a href="official_receipt1.php"> here</a> for the details.
        <h3>Company Name: GoldenCup Exim Marketing</br></h3>
        <h3>Thanks!</h3>
